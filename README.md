...
This project simulates an e-commerce dataset to explore customer behavior and predict product returns. It includes detailed preprocessing steps, exploratory data analysis (EDA), and a classification model using RandomForestClassifier.
